...
linux: LIBS += -L$$PWD/../../../GamePlay/gameplay/Debug/ -lgameplay
...
macx: LIBS += -L$$PWD/../../../GamePlay/gameplay/Debug/ -lgameplay
...
win32: CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../GamePlay/gameplay/Debug/debug/ -lgameplay
win32: CONFIG(release, debug|release): LIBS += -L$$PWD/../../../GamePlay/gameplay/Release/release/ -lgameplay
win32: CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../GamePlay/external-deps/lib/windows/x86_64/Debug/ -lgameplay-deps
win32: CONFIG(release, debug|release): LIBS += -L$$PWD/../../../GamePlay/external-deps/lib/windows/x86_64/Release/ -lgameplay-deps
...
win32: QMAKE_POST_LINK += $$quote(xcopy ..\../../../GamePlay\gameplay\res\shaders res\shaders\* /s /y /d$$escape_expand(\n\t))
win32: QMAKE_POST_LINK += $$quote(xcopy ..\../../../GamePlay\gameplay\res\ui res\ui\* /s /y /d$$escape_expand(\n\t))
win32: QMAKE_POST_LINK += $$quote(copy ..\../../../GamePlay\gameplay\res\logo_powered_white.png res$$escape_expand(\n\t))
